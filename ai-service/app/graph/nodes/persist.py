            ...
            if pool:
                ...
                async with pool.connection() as conn:
                    ...
                    try:
                        ...
                        logger.info("ai_trace_log: full INSERT OK")
                    except Exception as full_err:
                        # Full INSERT failed (likely missing columns from migration).
                        # Fallback to core-only INSERT so traces always write.
                        logger.warning(f"ai_trace_log full INSERT failed, trying core fallback: {full_err}")
                        await conn.execute(
                            """
                            INSERT INTO ai_trace_log (
                                request_id, user_id, session_id, message,
                        ...
                        logger.info("ai_trace_log: core fallback INSERT OK")
        except Exception as e:
