...
VALUES (
  ...
  '{
    ...
    "library": [
      { "id": "plan_study",            "label": "Study",                "message": "plan my study schedule",              "enabled": true,  "allowInEmptyState": true,  "allowInResponse": true,  "tags": ["exam_soon","schedule_gap","response:text"],                     "excludeTags": [],                   "priority": 6 },
      { "id": "plan_training",         "label": "Train",                "message": "plan my training week",               "enabled": true,  "allowInEmptyState": true,  "allowInResponse": true,  "tags": ["empty_week","schedule_gap","has_programs","response:session_plan"], "excludeTags": ["rest_day","injury"], "priority": 6 },
      ...
      { "id": "check_benchmarks",      "label": "My Benchmarks",        "message": "show me my benchmarks",               "enabled": true,  "allowInEmptyState": true,  "allowInResponse": true,  "tags": ["has_benchmarks","response:benchmark","always"],                 "excludeTags": [],                   "priority": 5 },
