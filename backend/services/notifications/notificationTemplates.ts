...
export const NOTIFICATION_TEMPLATES: Record<NotificationType, NotificationTemplate> = {
  ...
  LOAD_WARNING_SPIKE: {
    ...
    primary_action: { label: 'View load plan', deep_link: 'tomo://dashboard?filter=load' },
  ...
  SLEEP_QUALITY_DROPPING: {
    ...
    secondary_action: { label: 'View readiness', deep_link: 'tomo://dashboard' },
  ...
  NEW_RECOMMENDATION: {
    ...
    primary_action: { label: 'View on Dashboard', deep_link: 'tomo://dashboard?rec_id={rec_id}' },
  ...
  READINESS_TREND_UP: {
    ...
    primary_action: { label: 'View readiness', deep_link: 'tomo://dashboard' },
    expiry: { ttl_hours: 48 },
    can_dismiss: true,
  },
  ...
  EXAM_APPROACHING: {
    ...
    primary_action: { label: 'View adjusted plan', deep_link: 'tomo://dashboard?filter=academic' },
  ...
  DUAL_LOAD_SPIKE: {
    ...
    primary_action: { label: 'View recommendation', deep_link: 'tomo://dashboard' },
  ...
  TRIANGLE_ALIGNMENT_CHANGE: {
    ...
    primary_action: { label: 'View resolution', deep_link: 'tomo://dashboard?filter=triangle' },
    expiry: { ttl_hours: 168 },
    can_dismiss: true,
  },
