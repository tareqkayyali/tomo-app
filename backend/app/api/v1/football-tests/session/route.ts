...
const FOOTBALL_TEST_TO_METRIC: Record<string, { key: string; label: string } | ((unit: string) => { key: string; label: string })> = {
  ...
  "5-0-5":          { key: "agility_505", label: "5-0-5 Agility" },
  "5_10_5_agility": { key: "agility_5105", label: "5-10-5 Agility" },
  "5-10-5-agility": { key: "agility_5105", label: "5-10-5 Agility" },
  "t-test":         { key: "agility_ttest", label: "T-Test Agility" },
  "illinois-agility":{ key: "illinois_agility", label: "Illinois Agility" },
  "arrowhead-agility":{ key: "arrowhead_agility", label: "Arrowhead Agility" },
