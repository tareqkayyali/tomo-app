...
const TEST_CATALOG: TestCatalogItem[] = [
  ...
  // Strength
  { id: "1rm-bench", name: "Bench Press 1RM", category: "Strength", unit: "kg", emoji: "", description: "One rep max bench press", direction: "higher", tags: ["strength", "bench", "upper body", "1rm"] },
  { id: "1rm-squat", name: "Back Squat 1RM", category: "Strength", unit: "kg", emoji: "", description: "One rep max back squat", direction: "higher", tags: ["strength", "squat", "lower body", "1rm"] },
  { id: "deadlift-1rm", name: "Deadlift 1RM", category: "Strength", unit: "kg", emoji: "", description: "One rep max deadlift", direction: "higher", tags: ["strength", "deadlift", "1rm"] },
  ...
  // Body Composition
  { id: "body-weight", name: "Body Weight", category: "Body Comp", unit: "kg", emoji: "", description: "Total body mass", direction: "lower", tags: ["body", "weight", "composition"] },
  { id: "body-fat", name: "Body Fat %", category: "Body Comp", unit: "%", emoji: "", description: "Body fat percentage", direction: "lower", tags: ["body", "fat", "composition"] },
  ...
  { id: "bmi", name: "BMI", category: "Body Comp", unit: "kg/m²", emoji: "", description: "Body mass index", direction: "lower", tags: ["body", "bmi", "composition"] },
