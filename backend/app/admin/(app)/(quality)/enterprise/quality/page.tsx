  ...
  async function loadAll() {
    try {
      const [aggRes, flagsRes, disRes] = await Promise.all([
        ...
        fetch(
          "/api/v1/admin/enterprise/quality/safety-flags?status=open&limit=200",
          { credentials: "include" }
        ),
        fetch(
          "/api/v1/admin/enterprise/quality/disagreements?limit=1",
          { credentials: "include" }
        ),
      ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Link href="/admin/enterprise/quality/safety-flags">
        ...
        <Link href="/admin/enterprise/quality/disagreements">
          <Card className="p-4 hover:bg-accent transition-colors">
