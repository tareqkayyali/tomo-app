...
function createStyles(_colors: ThemeColors) {
  return StyleSheet.create({
    ...
    unread: { borderColor: colors.accentBorder },
    acted: { opacity: 0.85 },
    ...
    coachAvatarText: { fontSize: 13, fontFamily: 'Poppins_700Bold', color: colors.textPrimary },
    coachInfo: { flex: 1 },
    coachName: { fontSize: 13, fontFamily: 'Poppins_700Bold', color: colors.textPrimary },
    ...
    drillDate: { fontSize: 10, fontFamily: 'Poppins_400Regular', color: colors.textSecondary },
    drillName: { fontSize: 13, fontFamily: 'Poppins_700Bold', color: colors.textPrimary, marginBottom: 6 },
    ...
    addBtnText: { fontSize: 11, fontFamily: 'Poppins_700Bold', color: colors.textPrimary },
    viewScheduleBtn: {
      margin: 12,
      marginTop: 6,
      padding: 10,
