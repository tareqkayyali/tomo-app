...
assert(getShotRatingColor(80) === '#7A9B76', '80 → green');
assert(getShotRatingColor(55) === '#F39C12', '55 → yellow');
assert(getShotRatingColor(40) === '#F39C12', '40 → orange');
assert(getShotRatingColor(20) === '#5A6B7C', '20 → teal (growth)');
