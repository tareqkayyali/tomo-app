/**
 * Parent Profile Screen — Gen Z design
 *
 * Replaces ParentSettingsScreen. Merged profile + settings view.
 */
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setChildCount(res.children.length);
      } catch {
        // silent
      }
    })();
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <GlassCard>
          <View style={styles.profileRow}>
            <View style={[styles.avatar, { backgroundColor: colors.accent2 + '22' }]}>
              <Text style={[styles.avatarText, { color: colors.accent2 }]}>{initial}</Text>
            </View>
            <View style={{ flex: 1 }}>
              ...
              <View style={[styles.roleBadge, { backgroundColor: colors.accent2 + '18' }]}>
                <Text style={[styles.roleBadgeText, { color: colors.accent2 }]}>Parent</Text>
              </View>
            </View>
          </View>
        </GlassCard>
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { backgroundColor: colors.glass }]}>
            <SmartIcon name="people-outline" size={20} color={colors.accent2} />
            <Text style={[styles.statValue, { color: colors.textOnDark }]}>{childCount}</Text>
            <Text style={[styles.statLabel, { color: colors.textMuted }]}>Children</Text>
          </View>
        </View>
